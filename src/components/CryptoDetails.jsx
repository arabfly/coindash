...
const CryptoDetails = () => {
  ...
  return (
    <div className="crypto-details-container">
      <div className="crypto-detail-in-container">
        <Col>
          <Col className="coin-detail-container">
            <Col className="coin-heading-container">
              <Title level={2} className="coin-name">
                {cryptoDetails.symbol} - {cryptoDetails.name.toUpperCase()}{" "}
                Price
              </Title>
              <p>
          ...
          <Col className="stats-container">
            <Col className="coin-value-statistics">
              <Col className="coin-value-statistics-heading">
                ...
                <p>An overview showing the statis of {cryptoDetails.name}</p>
              </Col>
            ...
            <Col className="other-stats-info">
              <Col className="coin-value-statistics-heading">
                ...
                <p>An overview showing the statis of all cryptocurrencies</p>
              </Col>
